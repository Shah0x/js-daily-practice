...
let x = 0;
let y = "0";
console.log(x == y) in this line it the output is true bcz both datatype is diff but the inner value is same so it conver type and compare like it may be convert num into str or maybe s
// Check:
// x == y
// x === y